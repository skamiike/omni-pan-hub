...
exports.MissingAccountError = exports.InvalidSignatureTypeError = exports.InvalidAdminMarkerError = exports.InvalidWitnessSizeError = void 0;
exports.from = from;
...
function assertAccountBinding(type, account) {
    if (type === 'multisig' && account == null)
...
class MissingAccountError extends Error {
    constructor() {
        ...
        Object.defineProperty(this, "name", {
            ...
            configurable: true,
            writable: true,
            value: 'KeyAuthorization.MissingAccountError'
        });
    }
}
