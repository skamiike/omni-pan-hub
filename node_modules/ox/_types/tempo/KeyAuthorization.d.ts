...
import type { Compute, PartialBy, UnionPartialBy } from '../core/internal/types.js';
...
export type KeyAuthorization<signed extends boolean = boolean, bigintType = bigint, numberType = number, addressType = Address.Address> = {
    ...
    signature: SignatureEnvelope.Primitive<bigintType, numberType> | SignatureEnvelope.Multisig<bigintType, numberType>;
} : {
    signature?: SignatureEnvelope.Primitive<bigintType, numberType> | SignatureEnvelope.Multisig<bigintType, numberType> | undefined;
});
/** Signature that can authorize an access key. */
export type Signature<bigintType = bigint, numberType = number> = SignatureEnvelope.Primitive<bigintType, numberType> | SignatureEnvelope.Multisig<bigintType, numberType>;
...
type SignatureValue = SignatureEnvelope.from.MultisigFromConfig | UnionPartialBy<SignatureEnvelope.Primitive, 'prehash' | 'type'> | PartialBy<SignatureEnvelope.Multisig, 'type'> | SignatureEnvelope.Secp256k1Flat | SignatureEnvelope.Serialized;
...
export declare namespace from {
    type Options<signature extends SignatureValue | undefined = SignatureValue | undefined> = {
        ...
        signature?: signature | SignatureEnvelope.Primitive | SignatureEnvelope.Multisig | undefined;
    };
    ...
    type ErrorType = InvalidSignatureTypeError | MissingAccountError | Errors.GlobalErrorType;
}
/**
...
export declare class MissingAccountError extends Error {
    readonly name = "KeyAuthorization.MissingAccountError";
    constructor();
}
export {};
