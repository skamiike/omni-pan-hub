 ...
 */
export type SignatureEnvelope<bigintType = bigint, numberType = number> = EnvelopeOneOf<Secp256k1<bigintType, numberType> | P256<bigintType, numberType> | WebAuthn<bigintType, numberType> | Keychain<bigintType, numberType>, SignatureEnvelopeKey> | EnvelopeOneOf<Multisig<bigintType, numberType>, SignatureEnvelopeKey>;
/**
...
export declare namespace from {
    ...
    type Value = MultisigFromConfig | UnionPartialBy<SignatureEnvelope, 'prehash' | 'type'> | Secp256k1Flat | Serialized;
    type ReturnValue<value extends Value> = value extends Serialized ? SignatureEnvelope : value extends Secp256k1Flat ? Secp256k1 : value extends MultisigFromConfig ? Extract<SignatureEnvelope, {
        type: 'multisig';
    }> : IsNarrowable<value, SignatureEnvelope> extends true ? SignatureEnvelope : Assign<value, {
 ...
 */
export declare function sortMultisigApprovals(value: sortMultisigApprovals.Value): readonly Primitive[];
