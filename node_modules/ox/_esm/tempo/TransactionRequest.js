...
export function fromRpc(request) {
    const { authorizationList: _, multisigSimulation: __, keyAuthorizationSimulation: ___, ...rest } = request;
    ...
    if (request.keyAuthorizationSimulation)
        request_.keyAuthorizationSimulation = MultisigSimulation.fromRpc(request.keyAuthorizationSimulation);
...
export function toRpc(request) {
    ...
    if (request.keyAuthorizationSimulation)
        request_rpc.keyAuthorizationSimulation = MultisigSimulation.toRpc(request.keyAuthorizationSimulation);
    if (request.multisigSimulation)
